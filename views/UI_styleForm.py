...
class Ui_styleForm(object):
    def setupUi(self, styleForm):
        ...
        self.page_title.setGeometry(QtCore.QRect(0, 0, 250, 175))
        ...
        self.comboBox = QtWidgets.QComboBox(self.page_title)
        ...
        self.page_legend.setGeometry(QtCore.QRect(0, 0, 250, 175))
        ...
        self.comboBox_3 = QtWidgets.QComboBox(self.page_legend)
        self.comboBox_3.setObjectName("comboBox_3")
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.gridLayout_2.addWidget(self.comboBox_3, 1, 1, 1, 2)
        self.comboBox_2 = QtWidgets.QComboBox(self.page_legend)
        ...
        self.page_background.setGeometry(QtCore.QRect(0, 0, 250, 175))
    ...
    def retranslateUi(self, styleForm):
        ...
        self.label_5.setText(_translate("styleForm", "内容"))
        self.pushButton_2.setText(_translate("styleForm", "修改"))
        self.label_6.setText(_translate("styleForm", "显示"))
        self.pushButton_title_pallet.setText(_translate("styleForm", "调色板"))
        self.label.setText(_translate("styleForm", "颜色"))
        self.comboBox.setItemText(0, _translate("styleForm", "是"))
        self.comboBox.setItemText(1, _translate("styleForm", "否"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_title), _translate("styleForm", "标题"))
        self.label_4.setText(_translate("styleForm", "显示"))
        self.label_2.setText(_translate("styleForm", "位置"))
        self.comboBox_3.setItemText(0, _translate("styleForm", "是"))
        self.comboBox_3.setItemText(1, _translate("styleForm", "否"))
        self.comboBox_2.setItemText(0, _translate("styleForm", "右"))
        self.comboBox_2.setItemText(1, _translate("styleForm", "左"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_legend), _translate("styleForm", "图例"))
        self.label_3.setText(_translate("styleForm", "颜色"))
        self.pushButton_background_pallet.setText(_translate("styleForm", "调色板"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_background), _translate("styleForm", "背景"))
