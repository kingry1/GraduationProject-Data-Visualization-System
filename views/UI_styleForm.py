...
class Ui_styleForm(object):
    ...
    def retranslateUi(self, styleForm):
        ...
        self.comboBox_title_enable.setItemText(0, _translate("styleForm", "是"))
        self.comboBox_title_enable.setItemText(1, _translate("styleForm", "否"))
        ...
        self.comboBox_legend_enable.setItemText(0, _translate("styleForm", "是"))
        self.comboBox_legend_enable.setItemText(1, _translate("styleForm", "否"))
        self.comboBox_legend_position.setItemText(0, _translate("styleForm", "右"))
        self.comboBox_legend_position.setItemText(1, _translate("styleForm", "左"))
