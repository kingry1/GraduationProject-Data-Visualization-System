...
class Ui_DataVisualizationWin(object):
    def setupUi(self, DataVisualizationWin):
        ...
        DataVisualizationWin.resize(1128, 747)
        ...
        self.overallhorizontalLayout.addLayout(self.verticalLayout_3)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 298, 308))
        ...
        self.overallhorizontalLayout.addLayout(self.verticalLayout_71)
        ...
        self.overallhorizontalLayout.addLayout(self.verticalLayout_61)
        self.overallhorizontalLayout.setStretch(2, 1)
        self.horizontalLayout_2.addLayout(self.overallhorizontalLayout)
    ...
    def retranslateUi(self, DataVisualizationWin):
        ...
        item.setText(_translate("DataVisualizationWin", "test"))
        item = self.listWidget_4.item(1)
        item.setText(_translate("DataVisualizationWin", "test2"))
