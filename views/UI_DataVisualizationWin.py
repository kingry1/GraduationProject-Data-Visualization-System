...
class Ui_DataVisualizationWin(object):
    def setupUi(self, DataVisualizationWin):
        ...
        self.verticalLayout_parameter.addWidget(self.tableNameLabel, 0, QtCore.Qt.AlignVCenter)
        ...
        self.verticalLayout_parameter.addLayout(self.verticalLayout_6)
        ...
        self.verticalLayout_parameter.addLayout(self.verticalLayout_7)
        ...
        self.verticalLayout.addWidget(self.graphTypeLabel)
